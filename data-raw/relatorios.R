...
barao::relatorio_brasil_pais("Estados Unidos")
...
#                                    "Bonaire", "South Sudan", "Syria", "Saint Barthélemy", "Br. Virgin Isds", "Cayman Isds")
# 
# lista_paises <- unique(exp_imp_sh2$NO_PAIS)
# lista_paises <- lista_paises[! lista_paises %in% retirar_lista_paises_comtrade]
